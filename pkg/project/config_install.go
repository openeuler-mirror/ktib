...
type PackageInstaller interface {
	installPackages(tag, yumConfig, target string, packages ...string) error
}

type YumPackageInstaller struct{}

func (y YumPackageInstaller) installPackages(tag, yumConfig, target string, packages ...string) error {
